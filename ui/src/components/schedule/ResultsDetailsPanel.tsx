                ...
                {selectedSchedule ? (
                    <div className="border-t border-background/10 pt-4">
                        ...
                        <div className="text-sm text-background/70 space-y-1 mb-4">
                            ...
                            <p>
                                {selectedSchedule.summary.totalGapMinutes} total
                                gap minutes;{" "}
                                {selectedSchedule.summary.maxSingleGapMinutes}{" "}
                                maximum single gap
                            </p>
                            ...
                            <p>
                                {selectedSchedule.summary.ratedInstructorCount}{" "}
                                rated,{" "}
                        ...
                        <div className="flex flex-col gap-3">
                            {selectedSchedule.sections.map((section) => (
                                <div
                                    key={section.catalogSectionMeetingId}
